...
const Empleados = () => {
  ...
  const agregarEmpleado = async () => {
    ...
    try {
      const respuesta = await fetch('http://localhost:3002/api/registrarempleado', {
        method: 'POST',
  ...
  const obtenerEmpleados = async () => {
    try {
      const respuesta = await fetch('http://localhost:3002/api/empleados');
  ...
  const guardarEdicion = async () => {
    ...
    try {
      ...
      const respuesta = await fetch(`http://localhost:3002/api/actualizarEmpleadoPatch/${empleadoEditado.id_empleado}`, {
        method: 'PATCH',
        headers: { 'Content-Type': 'application/json' },
  ...
  const confirmarEliminacion = async () => {
    try {
      const respuesta = await fetch(`http://localhost:3002/api/eliminarempleado/${empleadoAEliminar.id_empleado}`, {
        method: 'DELETE',
      });
